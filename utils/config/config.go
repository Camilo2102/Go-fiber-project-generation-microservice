...
type folders = struct {
	RootFolder               string `toml:"root-folder"`
	AutoCrudModelFolder      string `toml:"auto-crud-model-folder"`
	AutoCrudRepositoryFolder string `toml:"auto-crud-repository-folder"`
}
